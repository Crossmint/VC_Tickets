...
export default function PurchaseCompleted() {
  ...
  useEffect(() => {
    ...
    }, 15000); // 6000 milliseconds = 6 seconds
  ...
  return (
    <div style={{ position: 'relative', minHeight: '100vh', backgroundColor: '#fff' }}>
      <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column', paddingTop: '1rem' }}>
        <div style={{ backgroundColor: '#F8F9FB', padding: '2rem', borderRadius: '0.5rem', boxShadow: '0 0 10px rgba(0, 0, 0, 0.1)', maxHeight: '600px', maxWidth: '400px', width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', marginTop: '1rem', marginBottom: '1rem' }}>
            <Image src={currentImage} alt="Display Image" width={150} height={150} />
            <p style={{ fontFamily: 'sans-serif', textAlign: 'center', fontSize: '1rem', color: '#285E63', marginTop: '1rem' }}>An email will be sent shortly!</p>
          </div>
        </div>
      </div>
    </div>
